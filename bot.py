...
# ==========================================
API_TOKEN = '8563504121:AAH3d2YdjvfBbp3lmPmwXOdo6VMU0zClIfg'  # ⚠️ টোকেন
ADMIN_ID = 6243881362
...
# 7. ⬇️ DOWNLOAD LOGIC (Real-Time Animation + Format Ask)
...
def plt_cb(c):
    ...
    # ⚠️ YouTube Block Logic Added Here
    if plat == "Youtube":
        uid = c.message.chat.id
...
def process_link(m):
    ...
    # ⚠️ YouTube Direct Link Block Logic Added Here
...
def final_dl(c):
    ...
    try:
        # YouTube & Other Support (NO COOKIES)
        opts = {
            'quiet': True, 
            'outtmpl': fn+'.mp4', 
